...
def global_commands(console):
    ...
    time.sleep(.5)
    print(send_command(console, cmd=b'usern {{ hidden }} pr 15 s ' + current_secret))
    time.sleep(.5)
...
def ntp_commands(console):
    print(send_command(console, cmd=b'ntp se {{ IP }}'))
    print(send_command(console, cmd=b'ntp se {{ IP }}'))
   

def dns_dhcp_commands(console):
    print(send_command(console, cmd=b'ip do n cop.net'))
    print(send_command(console, cmd=b'ip nam {{ IP }}'))
    print(send_command(console, cmd=b'ip do list {{ domain }}.net'))
    print(send_command(console, cmd=b'ip do list {{ hidden }}net'))
...
def tacacs_commands(console):
    print(send_command(console, cmd=b'tacacs- h {{ IP }}'))
    time.sleep(.5)
    print(send_command(console, cmd=b'tacacs- h {{ IP }}'))
    time.sleep(.5)
    print(send_command(console, cmd=b'tacacs- h {{ IP }}'))
    time.sleep(.5)
    print(send_command(console, cmd=b'tacacs- k 7 xxxxxxxxxxx'))
    print(send_command(console, cmd=b'tacacs- di'))

def acl_commands(console):
    print(send_command(console, cmd=b'access-list 66 permit {{ IP }}'))
    print(send_command(console, cmd=b'access-list 66 permit {{ IP }}'))
    print(send_command(console, cmd=b'access-list 66 permit {{ IP }}'))
    print(send_command(console, cmd=b'access-list 66 permit {{ IP }}'))
    print(send_command(console, cmd=b'access-list 66 permit {{ IP }}'))
    ...
    print(send_command(console, cmd=b'access-list 66 permit {{ IP }}'))
    print(send_command(console, cmd=b'access-list 66 permit {{ IP }}'))
    print(send_command(console, cmd=b'access-list 67 permit {{ IP }}'))
    print(send_command(console, cmd=b'access-list 88 permit {{ IP }}'))

def snmp_commands(console):
    print(send_command(console, cmd=b'snmp- h {{ IP }} {{ hidden }}'))
    print(send_command(console, cmd=b'snmp- h {{ IP }} {{ hidden }}'))
    print(send_command(console, cmd=b'snmp- h {{ IP }} {{ hidden }}'))
    print(send_command(console, cmd=b'snmp- h {{ IP }} {{ hidden }}'))
    print(send_command(console, cmd=b'snmp- com {{ hidden }} RO 66'))
    print(send_command(console, cmd=b'snmp- com {{ hidden }} RW 67'))
    print(send_command(console, cmd=b'snmp- com {{ hidden }} RO 88'))
...
def logging_commands(console):
    ...
    print(send_command(console, cmd=b'logging host {{ IP }}'))
    print(send_command(console, cmd=b'logging host {{ IP }}'))
    print(send_command(console, cmd=b'logging host {{ IP }}'))
