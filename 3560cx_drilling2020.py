...
host_name = ('alp-drilling-sw' + str(int(ip_split[3]) - 100))
...
def global_commands(console):
    ...
    time.sleep(.5)
    print(send_command(console, cmd= b'usern tombstone pr 15 s ' + new_secret))                
    time.sleep(.5)
    ...
    print(send_command(console, cmd= b'vlan 12'))
...
def access_int(console):
    ...
    time.sleep(.5)
    print(send_command(console, cmd= b'sw ac v 44'))
    time.sleep(.5)
    print(send_command(console, cmd= b'sw m a'))
    print(send_command(console, cmd= b'sw v v 247'))
    time.sleep(.5)
...
def acl_commands(console):
    ...
    print(send_command(console, cmd= b'access-list 66 permit 136.226.86.125'))
    print(send_command(console, cmd= b'access-list 66 permit 136.226.130.30'))
    print(send_command(console, cmd= b'access-list 66 permit 136.226.130.16'))
    ...
    print(send_command(console, cmd= b'access-list 66 permit 144.46.136.96 0.0.0.31'))
    print(send_command(console, cmd= b'access-list 67 permit 136.226.130.30'))
    print(send_command(console, cmd= b'access-list 67 permit 136.226.130.16'))
...
def exec_banner(console):
    ...
    print(send_command(console, cmd= b'Department:        Drilling'))
